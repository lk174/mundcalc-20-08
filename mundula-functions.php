...
function mundula_enqueue_scripts() {
    ...
    if ( $is_kalkulator ) {
        ...
        wp_enqueue_style( 'mundula-kalkulator-css', content_url( '/kalkulator/mundula-kalkulator.css' ), [], '3.1' );
        wp_enqueue_script( 'mundula-kalkulator-js', content_url( '/kalkulator/mundula-kalkulator.js' ), [ 'jquery' ], '3.1', true );
