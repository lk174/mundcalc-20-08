...
";
    ...
    wp_redirect( admin_url( 'admin.php?page=mundula-panel&saved=1&id=' . $post_id ) );
    exit;
}
...
function mundula_panel_edit( $post_id ) {
    ...
    if ( ( ! $stopien_nowy_meta || ! $stopien_obszyty_meta ) && ! empty($zakres) ) {
        ...
        if ( ! $stopien_nowy_meta ) {
            $stopien_nowy_meta = $extracted_fallback['nowy'];
        }
        if ( ! $stopien_obszyty_meta ) {
            $stopien_obszyty_meta = $extracted_fallback['obszyty'];
        }
    }
                        ...
                        <table class="form-table" style="margin:0">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    // Sformatuj wartość dla pola input type="date" (format YYYY-MM-DD)
                                    $dg_date_value = '';
                                    if ($dg) {
...
", $m['_adres'] ?? '');
                ...
                <div class="postbox" style="margin-top:16px">
                    ...
                    <!-- NOWA SEKCJA: STAN WYDANIA / WYSYŁKI -->
                    <?php
                    ...
                    <div id="dostawa-status-wydania" style="margin-top:16px; border-top:1px solid #eee; padding-top:16px;">
                        <table class="form-table" style="margin:0">
                            ...
                            <!-- Sekcja częściowa (zarządzana przez JS) -->
            ...
            <div>
                ...
                <div class="postbox">
                    ...
                    <div class="inside" style="padding:16px;">
                        ...
                        <div style="margin-bottom:16px;" id="elementy-dostarczone">
                            ...
                            // Mapowanie starych kluczy na nowe dla zachowania kompatybilności wstecznej
                            $key_mapping = [
                ...
                <div class="postbox" style="margin-top:16px">
                    ...
                    <div class="inside" style="padding:16px;">
                        ...
                        <?php if ( ! empty($photos) ): ?>
                            <div style="display:grid; grid-template-columns: repeat(auto-fill, minmax(100px, 1fr)); gap:12px; margin-bottom:16px;">
                                <?php foreach ( $photos as $p ):
                                    $view_url = admin_url('admin-post.php?action=mundula_view_photo&post_id=' . $post_id . '&file=' . urlencode($p['file']));
                        ...
                        <?php else: ?>
                            <div style="padding:12px; background:#f9f9f9; color:#666; border-radius:4px; text-align:center; font-size:13px; margin-bottom:16px;">
                        ...
                        <div style="border-top:1px solid #eee; padding-top:12px;">
                            ...
                            <input type="file" name="mundula_photos[]" multiple accept="image/*" style="width:100%; font-size:13px;">
